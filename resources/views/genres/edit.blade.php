...
@section('content')
    ...
    <div class="container-fluid mt-5 mb-3">
        ...
        <h3>MODIFICA IL GENERE</h3>
        <p>* I dati riportati con l'asterisco sono obbligatori</p>
        <hr class="mb-5" />

        {{-- ------------------- Sezione form modifica un regista: ------------------- --}}
        {{-- Passo con le props sia il la variabile del model (se necessario, in questo caso passo $genre), sia l'action che il metodo http, e anche le singole input type di cui ho bisogno --}}
        <x-form-data 
        :model="$genre" 
