...
@section('content')
    ...
    <div class="container-fluid mt-5 mb-3">
        ...
        <h3>REGISTI</h3>
        <p>Scheda anagrafica dei registi</p>
            <hr />


            {{-- --------- Sezione Pulsanti modifica ed elimina --------- --}}
        <div class="d-flex flex-wrap justify-content-start pt-3 gap-3">
            <button class="btn-modifica"><a href="{{ route('directors.edit', $director) }}">Modifica</a></button>
        ...
        {{-- ------------------- Sezione dettagli regista: ------------------- --}}
        <div class="card shadow-sm my-5">
            <div class="card-header bg-dark text-white">
                <i class="bi bi-camera-reels me-3"></i>
                <span>{{ strtoupper('regista') . ': ' }}</span>
                <span class="show-movies">{{ strtoupper($director->getFullNameAttribute()) }}</span>
            </div>

            <div class="card-body">
                <div class="fs-2 my-4"><i class="fa-solid fa-film me-3"
                        style="max-width: 20px;"></i>{{ $director->getFullNameAttribute() }}</div>
                ...
                <div class="mb-2 d-flex py-1 border-bottom">
                    ...
                    <div class="fw-bolder" style="color: #DB2B39;">{{ $director->first_name }}</div>
                </div>
                ...
                <div class="mb-2 d-flex py-1 border-bottom">
                    ...
                    <div class="fw-bolder" style="color: #DB2B39;">{{ $director->last_name }}</div>
                </div>
                ...
                <div class="mb-2 d-flex py-1 border-bottom">
                    ...
                    @else
                        ...
                        @php
                            ...
                            $dateFormatted = \Carbon\Carbon::createFromFormat('Y-m-d', $director->birth_date)
                                ->locale('it')
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel"><strong>{{ $director->getFullNameAttribute() }}</strong></h1>
