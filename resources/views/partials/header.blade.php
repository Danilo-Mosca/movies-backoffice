...
<header class="row mt-3">
    <div class="col d-flex justify-content-center">
        <a href="#" class="a-link-header"><img src="{{ Vite::asset('resources/img/icons/directors-icon.png') }}" alt="Logo"
                height=""><p class="header-text-menu">Registi</p></a>
    </div>
    <div class="col d-flex justify-content-center">
        <a href="#" class="a-link-header"><img src="{{ Vite::asset('resources/img/icons/What-we-do-custom-img-8.png') }}" alt="Logo"
                height=""><p class="header-text-menu">Genere</p></a>
    </div>
    <div class="col d-flex justify-content-center">
        <a href="#" class="a-link-header"><img src="{{ Vite::asset('resources/img/icons/What-we-do-custom-img-2.png') }}" alt="Logo"
                height=""><p class="header-text-menu">Film</p></a>
    </div>
    <div class="col d-flex justify-content-center">
        <a href="#" class="a-link-header"><img src="{{ Vite::asset('resources/img/icons/What-we-do-custom-img-3.png') }}" alt="Logo"
                height=""><p class="header-text-menu">Attori</p></a>
    </div>
    <div class="col d-flex justify-content-center">
        <a href="#" class="a-link-header"><img src="{{ Vite::asset('resources/img/icons/What-we-do-custom-img-7.png') }}" alt="Logo"
