...
@section('content')
    ...
    <form method="GET" action="{{ route('actors.index') }}">
        <div class="d-flex flex-wrap row gap-3 ms-2 me-2">
            ...
            <button class="col-12 col-md-2" id="delete"><a href="{{ route('actors.index') }}">Reset</a></button>
        </div>
    </form>
    ...
    <div class="container-fluid mt-5 mb-3">
        ...
        @if ($actors->isEmpty())
            <div class="alert alert-warning mt-3">
                Nessun attore trovato con i valori di ricerca inseriti.
            </div>
        @endif
    ...
    <div class="d-flex flex-column flex-md-row justify-content-center align-items-center mt-4">
        <div class="text-muted mb-2 mb-md-0">
            ...
            Mostrati da <strong>{{ $actors->firstItem() }}</strong> a <strong>{{ $actors->lastItem() }}</strong> di <strong>{{ $actors->total() }}</strong> risultati
        </div>
    </div>
    <div class="d-flex flex-column flex-md-row justify-content-center align-items-center mt-4">
